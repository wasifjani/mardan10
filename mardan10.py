...
def men():
    ...
    if rana == '':
        ...
        os.system('clear')
        wasif('[!] \x1b[1;92mPlease Wait While Page Is Loding.')
        hopss('10%..Wait.')
        hopss('20%.5..')
        hopss('50%..4.')
        hopss('70%.3..')
        ...
        os.system('clear')
        print banner
        wasif('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Tool Is Updating')
        os.system('git pull origin master')
        wasif('[\xe2\x9c\x93] \x1b[1;92mTool Has Been Update Successfully')
        wasif('[\xe2\x9c\x93] \x1b[1;92mPlease Wait While Update Is Setting Up On Your Mobile Phone')
        time.sleep(3)
        os.wasif('python2 wasi.py')
    elif rana == '6':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100037255963692')
        menu()
    elif rana == '7':
        os.system('rm -rf login.txt')
        wasif('[\xe2\x9c\x93] Logged Out Successfully')
        os.system('python2 wasi.py')
    else:
        print '[!] \x1b[1;91mWrong Input'
        men()
...
def crack_menu():
    ...
    if crm == '':
        ...
        try:
            ...
            wasif('\x1b[1;97m[\xe2\x9c\x93] \x1b[1;95mAccount Name \x1b[1;97m:\x1b[1;97m ' + op['name'])
        except KeyError:
        ...
        print 'Filled Incorrectly'
        crack_menu()
    wasif('[\xe2\x9c\x93] \x1b[1;96mTotal Friends: ' + str(len(id)))
    time.sleep(0.5)
